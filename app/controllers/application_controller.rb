class ApplicationController < ActionController::Base
  ...
  def verify_item_available
    if !@item.available && !current_user.try(:admin)
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :address, :city, :state_id, :zip, :email, :phone, :stripeToken])
  end
